...
class XArm7(mi.ManipulatorInterface):
    ...
    def __init__(self,
        ...
        self.jlc.anchor.lnk_list[0].cmodel.rgba = bc.tab20_list[15]
        ...
        self.jlc.jnts[0].lnk.cmodel.rgba = bc.tab20_list[15]
        ...
        self.jlc.jnts[1].lnk.cmodel.rgba = bc.tab20_list[15]
        ...
        self.jlc.jnts[2].lnk.cmodel.rgba = bc.tab20_list[15]
        ...
        self.jlc.jnts[3].lnk.cmodel.rgba = bc.tab20_list[15]
        ...
        self.jlc.jnts[4].lnk.cmodel.rgba = bc.tab20_list[15]
        ...
        self.jlc.jnts[5].lnk.cmodel.rgba = bc.tab20_list[15]
        ...
        self.jlc.jnts[6].lnk.cmodel.rgba = bc.tab20_list[14]
